...
import dev.alejandroaitorjesusdiego.proyectoprogramacion3.gestion.sesion.Session
...
class NewTeamUserController () {
    ...
    @FXML
    lateinit var JornadaButton: MenuItem
    ...
    private fun initEvents() {
        ...
        JornadaButton.setOnAction {
            RoutesManager.initJornadaStage()
        }
